"""
Django settings for dashnor project.
...
SECRET_KEY = 'w5qis!024ka74-ol0nq0_wm(fc8p-if%0+2kvm(!wqw=&=)ryw'
...
WSGI_APPLICATION = 'dashnor.wsgi.application'
